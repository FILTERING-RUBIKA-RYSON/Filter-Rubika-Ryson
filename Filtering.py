...
if up == "1":
        ...
        print ('code for Channel ≠>' + '%s%s ((6.0.5.8.c1./c.h.p.k.w////7077/6.2.9.0.5.2.7.9.g0/k/j/a/f7.9.3.1.3.8.6.6)) %s' % (fg('red'), bg('yellow'), attr('reset')))
...
if up == "2":
        print ('code group ≠>' + '%s%s [|1.4.h.py/p[1-V≈V-1]0.fi/1.6|] %s' % (fg('white'), bg('black'), attr('reset')))
...
if up == "3":
        ...
        print ('code Filter account ≠>' + '%s%s (3.9.0.1/g0/k1/j/j/f/a/a.0.6.3.0.3.3.5.1.6.8.4.2.6.0.3.2.4.7.9.3_8) %s' % (fg('red'), bg('yellow'), attr('reset')))
