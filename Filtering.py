...
print("                      RUBIKA= On -- @Spansor")
print ("                telegram @Creator_Ryson")
...
if up == "0":
    print(' (Super) Fil Code  ≠>' + '%s%s (5.6.0.2/6.106.10.226-:!8.0.1.7.8.0.3.1.0.4.6.1.7.9.2.8.1.3.0.6.4!)%s' % (fg('red'), bg('black'), attr('reset')))


if up == "1":

        print ('code Fil Channel ≠>' + '%s%s (6.er/F///h//f///h.6.7.0.1.7.8.0.1.4.8.0.1.2.8.0.0.1.5.8.9.310.561) %s' % (fg('red'), bg('yellow'), attr('reset')))
...
if up == "2":
        print ('code group ≠>' + '%s%s  (/p.sh/h.k.p.c.h.o.a.h.s.i.u/:!8.0.1.5!#51126/!///!//!///157.621) %s' % (fg('white'), bg('black'), attr('reset')))
...
if up == "3":
        ...
        print ('code Filter account ≠>' + '%s%s (http://f///h//c//a///4.2.5.7.4.3.4.6.7.9.8.5.2.5.7.9.5.2.3.6.8.0.0.9.6.1) %s' % (fg('red'), bg('blue'), attr('reset')))
...
print("")
print("")
print("         </MMD RYSON vs Cassifer> ❤️❤️")
print ("")
time.sleep(0.3)
print(f"{red}" )
time.sleep(1)
