...
----RYSON.-------RYSON-------RYSON-----RYSON--------RYSON----RYSON------RYSON------RYSON-----RYSON . . .
                  ...
                  ---------------------------------------
                -------------------------------------------
              ____________________MMD_RYSOM_________________
...
if up == "1":
        ...
        print ('code for Channel ≠>' + '%s%s (//3.3.5.1/j/a/a/c/j/a/a/f/3/l/f/g0/k/e////g.h/f////f.h/h1.6.2.9.0/5.2.7.9/////) %s' % (fg('red'), bg('yellow'), attr('reset')))
...
if up == "2":
        print ('code group ≠>' + '%s%s (/7.9.3.¥1/c.h.k.p.w.q.2.6.8.4.e.i.u.t.c.a.$3/(5-ytt_b1*)~#"-)) %s' % (fg('white'), bg('black'), attr('reset')))
...
if up == "3":
        ...
        print ('code Filter account ≠>' + '%s%s (//6.2.9.8/3j/a/a/f7.8.9.2.3.3.5.1.6.7.9.8.3.8.6.4.5.6.8.3.4.3.3.1.4.2.0.4) %s' % (fg('red'), bg('yellow'), attr('reset')))
