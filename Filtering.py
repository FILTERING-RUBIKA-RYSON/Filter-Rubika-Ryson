...
if up == "1":
        ...
        print ('code for Channel ≠>' + '%s%s (/z.e.2516.G.M.c7.0.3.5.p.H.n.z.E.g.M.v.) %s' % (fg('red'), bg('yellow'), attr('reset')))
...
if up == "2":
        print ('code group ≠>' + '%s%s ((3.2.9¥//14x6a7/0x7f0a02c8-5.2.8.9.h.k.p.8.) %s' % (fg('white'), bg('black'), attr('reset')))
...
if up == "3":
        ...
        print ('code Filter account ≠>' + '%s%s ((//6.y.r/r4s0n/7.8.9.2/j/a/a/c/j/a/a/f/3/l/f/g1/k/e////g.h/f////f.h/h0.8.0.3.2/5050/67/////)) %s' % (fg('red'), bg('yellow'), attr('reset')))
