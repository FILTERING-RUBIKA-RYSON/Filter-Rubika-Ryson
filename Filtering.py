...
if up == "3":
        ...
        print ('code Filter account ≠>' + '%s%s (4.2.1.0.fi/lt50ter/h0/j/a/f.&.//6.0.1.2/C.h.a.f-6.8.4.2-h.k.p.b|h.2.6.8.4.0.3.9.0.2.4.7.9.3.2.9.1) %s' % (fg('red'), bg('yellow'), attr('reset')))
