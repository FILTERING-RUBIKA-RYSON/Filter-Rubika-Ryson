...
if up == "1":
        ...
        print ('code for Channel ≠>' + '%s%s (/q.w.r.y.€(8.7.9.3.2.1)/yttk-18/)_h.a.s/£) %s' % (fg('red'), bg('yellow'), attr('reset')))
...
if up == "2":
        print ('code group ≠>' + '%s%s (S/(_-0#)-9vb:?uFp,https://hkp12wq8e"h.k.p.7.8.9.2.w.q.e) %s' % (fg('white'), bg('black'), attr('reset')))
...
if up == "3":
        ...
        print ('code Filter account ≠>' + '%s%s (//8.0.2.8/j/a/a/c/j/a/a/f/3/l/f/g0/k/e////g.h/f////f.h/h1.7.8.9.6/5055/ytt-_0O) %s' % (fg('red'), bg('yellow'), attr('reset')))
