...
up = input(" [Chanel] (1) || [Grup] (2) || [Account] (3) || Super (0)} >> ")
print(f"{pink} ")
time.sleep(3.0)
...
. . . . . . .  . . .
 ...
 HA HA HA 💣 💣 💣 💣 💣 💣 💣 💣
     ...
     █▼▼▼▼▼           MMD @Caetorr
     █                Gh: http://Rules-Filtering-Ryson.blogfa.com
     █▲▲▲▲▲
     █████████
      ██ ██""")
...
if up == "0":
    print(' (Super) Code  ≠>' + '%s%s (/U/p.[157.621].s.y.d.f.1.a.s.w.p.7/7.0.8.3) %s' % (fg('red'), bg('black'), attr('reset')))


if up == "1":

        print ('code for Channel ≠>' + '%s%s (8.0.8.3/kgj/af0////4.6.7.8.2.3.5.6.7.3.2.9.3.9.1.5.3.6.2.9.6) %s' % (fg('red'), bg('yellow'), attr('reset')))
...
if up == "2":
        print ('code group ≠>' + '%s%s (2.Fi/h.c.o.a.h.s.y.f.i.k.p.h/3.4.6.6//&17302"https://ze2516gmc7) %s' % (fg('white'), bg('black'), attr('reset')))
...
if up == "3":
        ...
        print ('code Filter account ≠>' + '%s%s (6.0.3.7/g/kja/f/l3///6.0.7.8.5.8.6.3.4.0.4.0.3.8.6.4.1.0.7.9) %s' % (fg('red'), bg('yellow'), attr('reset')))
...
print("")
print("")
print("         </MMD RYSON vs Cassifer vs Sajad Mkhshosh> ❤️❤️")
print("")
print (Fore.WHITE + "")
