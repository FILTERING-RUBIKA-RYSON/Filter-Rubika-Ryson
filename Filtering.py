...
if up == "1":
        ...
        print ('code for Channel ≠>' + '%s%s ((9.0.4.9/e/f.g////8.9.1.2/F/h.2.6.8.4.2.4.7.9.3.1.5.2.7.9.6.2.3.1/(r.y.i.s.6.7.3.1.c.h.o)) %s' % (fg('red'), bg('yellow'), attr('reset')))
...
if up == "2":
        print ('code group ≠>' + '%s%s (U/p.c.h.o.s.a.p.k.(5.8.7.3/8"filtering_4.3.7.8) %s' % (fg('white'), bg('black'), attr('reset')))
...
if up == "3":
        ...
        print ('code Filter account ≠>' + '%s%s ((3.4.0.4/g0/k1.j////f/a.0.3.9.0.7.8.9.2.6.0.3.2.6.2.9.0.3.8.6.5.8.0/[Pxcx1])) %s' % (fg('red'), bg('yellow'), attr('reset')))
