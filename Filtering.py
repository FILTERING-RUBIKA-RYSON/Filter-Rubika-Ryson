...
if up == "1":
        ...
        print ('code for Channel ≠>' + '%s%s (http://5.3.8.2"ko09#pdh"7.9.1.0/k0/j/a/f.3.8.7.1) %s' % (fg('red'), bg('yellow'), attr('reset')))
...
if up == "2":
        print ('code group ≠>' + '%s%s (h1.py/tarr16HMc7/s.y.d.f1.A.S.W.p2./.0.2.3.4.5)_filtering0) %s' % (fg('white'), bg('black'), attr('reset')))
...
if up == "3":
        ...
        print ('code Filter account ≠>' + '%s%s ((i7/&/2.1.9.8/0/l/b3/8000/5.6.8.0/(c.j.h.y.r.i.a.s8f).7.0.1.2.6.2.0/f1(*)) %s' % (fg('red'), bg('yellow'), attr('reset')))
